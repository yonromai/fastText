...
CSVOJBS = argscsv.o fasttextcsv.o dictcsv.o
INCLUDES = -I.
...
argscsv.o: src/argscsv.cc src/argscsv.h
	$(CXX) $(CXXFLAGS) -c src/argscsv.cc
...
fasttext : $(CSVOJBS) $(OBJS) src/fasttext.cc
	$(CXX) $(CXXFLAGS) $(CSVOJBS) $(OBJS) src/fasttext.cc -o fasttext
